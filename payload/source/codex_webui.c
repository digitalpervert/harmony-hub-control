...
static void ir_setup_flow(FILE *f, const struct ir_inventory *inv) {
    ...
    fprintf(f, "<div class='wizard-panel active' data-panel='device'><div class='callout'><strong>Start with the device profile.</strong>Name the real device and enter the manufacturer and model. Search will use these details on the next step, and saving the profile will keep this device selected.</div><form id='profileDeviceForm' method='post' action='/ir/new-device#ir'>");
    ...
    fprintf(f, "<div class='actions'><button type='submit'>Save Device And Search Codes</button><button id='profileSearch' type='button' class='secondary'>Search Codes Without Saving</button><button type='button' class='ghost' data-next-step='learn'>Learn From Remote</button></div></form></div>");
